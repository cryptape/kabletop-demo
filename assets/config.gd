...
var NativeNFTs = {
	1: Card.generate(1, "魔法预言", 3, "回合结束后，抽1张牌"),
	2: Card.generate(0, "百裂斩", 3, "造成2点伤害，对手损失1点能量"),
	3: Card.generate(3, "天使恩泽", 0, "增加2点能量，对手回复2点生命"),
	4: Card.generate(2, "恶魔契约", 0, "消耗2点生命，增加2点能量")
}
...
var NFTs = {
	...
	"d046a18f7e01cb42e911fae2f11ba60c9c6834f8":
		Card.generate(1, "火炼真金", 2, "维持2回合，每回合损失2点生命、增加2点能量"),
