...
local templates = {
	...
	-- 百裂斩
	[2] = generate(
		3, nil, pack(effects.damage(2, "bladewind"), effects.depower(2)), nil, nil
	),
	-- 天使恩泽
	[3] = generate(
	...
	-- 恶魔契约
	[4] = generate(
		0, pack(effects.damage(2, "bladewind"), effects.empower(3)), nil, nil, nil
	),
	-- 充能
	...
	["d046a18f7e01cb42e911fae2f11ba60c9c6834f8"] = generate(
		3, nil, nil, pack(buffs.holypower(3, 3)), nil
	),
	-- 能量流失
	...
	["36248218d2808d668ae3c0d35990c12712f6b9d2"] = generate(
		0, pack(effects.damage(2, "firebomb"), effects.empower(4)), nil, nil, nil
	),
	-- 嗜血
	["f49ac4925959733cc4c2b3a2663bde8c27b8dde2"] = generate(
		6, pack(effects.heal(5)), pack(effects.damage(5, "firebomb")), nil, nil
	),
	-- 雷鸣
	...
	["9285def08d45c203d83e13c5363627b8e95b3675"] = generate(
		0, nil, nil, pack(buffs.niceevil(1, 1)), nil
	),
	-- 大开杀戒
	...
	["ef28b677015404f9ee466b950d880f6d78709ef1"] = generate(
		5, nil, pack(effects.damage(3), effects.strip(2, subeffect("damage", "owner", 2))), nil, nil
	),
	-- 冥想
	["cd58caae1dd06b8074cc55283dabfb7c8df784a7"] = generate(
		5, pack(effects.heal(3)), nil, pack(buffs.holylight(2, 3)), nil
	),
	-- 能量溢出
	["f9c2d5a3d7eba0bcd7973ae48c5db7937c363547"] = generate(
		0, pack(effects.empower(4)), nil, nil, pack(buffs.holypower(3, 1))
	),
	-- 意外打击
	["68db1cc5dd2707bc19588c228cd8771efebe44c8"] = generate(
		2, nil, pack(effects.depower(0), effects.draw(1)), nil, nil
	),
	-- 副作用面具
	...
	["fde2a70cffa777c0fc53c29aae1452c17147feb2"] = generate(
		3, nil, pack(effects.damage(5, "firedragon")), nil, nil
	),
	-- 凌波微步
	["112c40c02594af5565e4a1c453b3f2f1d1b34a15"] = generate(
		3, pack(effects.draw(2)), nil, pack(buffs.evilcard(1, 1)), nil
	),
	-- 迷惑之眼
	...
	["b6d0f5c53b968052fb29d7c98a82e1b89af86b93"] = generate(
		3, nil, pack(effects.depower(5)), nil, nil
	),
	-- 生命培育
	...
	["1dac1c52818c97477b46f8e38514f8a4bd2e935e"] = generate(
		0, pack(effects.empower(4), effects.damage(4, "firedragon"), effects.draw(1)), nil, nil, nil
	),
	-- 精神失控
	...
	["5ceb75a6a1990b6fde9f6c3d9d7b9731c630630a"] = generate(
		5, nil, nil, pack(buffs.cardmaster(1, 3)), nil
	),
	-- 关键零件
	...
	["66b7fc8a970de2b83eb01720d51dc04b08ffdaba"] = generate(
		0, pack(effects.empower(10)), nil, pack(buffs.evilcard(2, 1)), nil
	),
	-- 天使的恩赐
	["8ba97786d1e7db828553c318fc71ff5bd40af323"] = generate(
		10, pack(effects.draw(3), effects.heal(15)), nil, nil, nil
	),
	-- 充能闪电
	...
	["ac74824a6c938ad7b83a1380d75862a420cdfe1a"] = generate(
		4, nil, nil, pack(buffs.holylight(2, 2), buffs.shield(2, 2)), nil
	),
	-- 替身攻击
	...
	["ad78dd763e70b8b89a41f4a0ff34896d5447513e"] = generate(
		2, nil, pack(effects.strip(1, subeffect("damage", "owner", 3))), nil, nil
	),
	-- 弱点分析
	["373efffe4f0fb741c00bf95864a83d85c26b4662"] = generate(
		5, nil, pack(effects.depower(3), effects.undraw(1)), nil, nil
	),
	-- 献祭
	["657f232232088ef1b1dbc3ecbd07ba9d18844d7a"] = generate(
		3, pack(effects.strip(0, subeffect("damage", "opposite", 3))), nil, nil, nil
	),
	-- 反射护罩
